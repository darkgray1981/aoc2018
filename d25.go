...
func main() {
	...
	p1(INPUT) // INPUT = 399, INPUT1 = 2, INPUT2 = 4, INPUT3 = 3, INPUT4 = 8
}
...
func p1(input string) {
	...
	graph := make(map[Point]map[Point]bool)
